...
./experiments/scripts/jg_basic_train_ao_nyudv2_vgg16.sh 0 ao_d_raw_HHA_focus_8bits nyud_v2_trainvalGupta_d_raw_HHA_focus_8bits nyud_v2_testGupta_d_raw_HHA_focus_8bits 20000

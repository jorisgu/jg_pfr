    # --------------------------------------------------------
# Faster R-CNN selector
# Basis written by Ross Girshick
# Modified by Joris Guerry
# --------------------------------------------------------
...
class nyud(imdb):
    def __init__(self, image_set, year, chanel, devkit_path=None):
        ...
        self.chanel = chanel
        # /home/jguerry/workspace/jg_pfr/data/nyud/nyud_v2
    ...
    def image_path_from_index(self, index):
        ...
        # /home/jguerry/workspace/jg_pfr/data/nyud/nyud_v2/data/rgb/[index]+[ext]
        image_path = os.path.join(self._data_path, self.chanel,
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_nyud_annotation(index)
    ...
    def rpn_roidb(self):
        if self._image_set != 'test':
            gtRoidb = self.gt_roidb()
            rpnRoidb = self._load_rpn_roidb(gtRoidb)
            roidb = imdb.merge_roidbs(gtRoidb, rpnRoidb)
        else:
    ...
    def _load_nyud_annotation(self, index):
        """
        Load image and bounding boxes info from NYUD data
        """
    ...
    def _do_python_eval(self, output_dir = 'output'):
        ...
        for i, cls in enumerate(self._classes):
            ...
            filename = self._get_nyud_results_file_template().format(cls)
            rec, prec, ap = voc_eval(filename, annopath, imagesetfile, cls, cachedir, ovthresh=0.3,use_07_metric=use_07_metric)
            aps += [ap]
